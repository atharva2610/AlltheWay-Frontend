...
export default function OrderHistory(){
    ...
    useEffect(()=>{
        window.scrollTo(0,0);
        // GET PAST ORDERS LIST REQUEST
        (async ()=>{
            const [data, responseStatus] = await serverRequest(`/api/owner/orders/${restaurant.id}/past/`, "GET", true);
    ...
    return (
        ...
        :
            <>
                <h1 className="text-2xl font-bold mb-16">Order History</h1>
